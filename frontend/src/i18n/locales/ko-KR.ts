export default {
  ...
  integrations: {
    ...
    claw: {
      title: 'dixian Skill',
      subtitle: 'dixian REST API로 문서를 가져오고 하이브리드 검색(벡터+키워드)을 수행합니다. 파일/URL/Markdown 업로드 및 검색에 사용.',
      ...
      installCtaHint: 'dixian Skill 설치 · 새 탭에서 열림',
    ...
    chrome: {
      title: '지식 관리 어시스턴트',
      subtitle: '자체 호스팅 dixian과 함께: 사이드바에서 질문하고, 웹 페이지를 클리핑하며, Markdown 메모를 지식베이스에 저장하세요.',
      ...
      steps: {
        ...
        port: {
          title: '데스크톱: 고정 포트(권장)',
          desc: 'dixian 데스크톱에서는 API 정보에서 고정 포트(예: 37841)를 설정하세요.'
        },
        api: {
          title: 'API 자격 증명',
    ...
    api: {
      ...
      capabilityManageModelsHint: '모델 설정, 자격 증명, 연결 테스트 및 dixian Cloud 자격 증명을 관리합니다.',
      ...
      signedFlowDetail: 'HMAC secret은 dixian과 신뢰할 수 있는 백엔드에만 보관하세요. 요청에 넣거나 브라우저에 배포하지 마세요. 요청 헤더에는 secret이 아니라 해당 secret으로 서명한 JWT 문자열을 넣습니다(발급마다 또는 만료 후 변경). JWT에는 sub(외부 사용자 ID), tenant_id, aud=weknora, exp(최대 24시간)가 필요합니다.',
      ...
      hmacSecretDesc: 'dixian에 저장된 것과 동일한 secret. 백엔드에서 JWT 서명에만 사용하며 요청 헤더로 보내지 않습니다.',
  ...
  system: {
    ...
    frontendVersionDescription: 'dixian UI 빌드 버전 번호',
  ...
  createChat: {
    title: '안녕하세요, dixian입니다 — 당신의 지식을 손끝에',
  ...
  auth: {
    ...
    registerSubtitle: '계정을 만들고 dixian을 시작하세요',
  ...
  settings: {
    ...
    storage: {
      ...
      pathPrefixPlaceholder: '예: dixian/images',
      prefixPlaceholder: '예: dixian',
    ...
    weknoraCloud: {
      ...
      addModelsDisplayName: {
        chat: 'dixian Cloud 대화',
        embedding: 'dixian Cloud Embedding',
        rerank: 'dixian Cloud ReRank',
        vllm: 'dixian Cloud 비전'
      },
      modelsSection: {
        title: '클라우드 모델',
        descReady: 'dixian Cloud의 네 가지 표준 모델을 등록하여 대화, 검색, 재정렬, 비전에 사용합니다.',
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: '지식 베이스 만들기',
        desc: '모든 것의 시작점입니다. 문서, 웹페이지, FAQ를 업로드하면 dixian이 자동으로 분석하고 색인합니다. 여기를 클릭해 지식 베이스로 이동하세요.'
      },
      welcome: {
        title: 'dixian에 오신 것을 환영합니다',
